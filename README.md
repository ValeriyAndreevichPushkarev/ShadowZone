...
Or more than 100 TOps (int4) for 15 mW light source. (Note that with quasi-stationary levels you can simply ignore power consumtion of a photodetectors, for example )
